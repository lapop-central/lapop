...
grep("ing4", notes$variable_name)
notes[c(1791, 1792, 3199, 3200, 3201, 3202, 3203, 3204, 4201, 4202, 5953, 5954, 7422, 7423), ]
```
...
```{r, SET ATTRIBUTES, warning=FALSE}
# English
cm23<-lpr_set_attr(cm23, notes, noteid = "note2", attribute_name = "qwording_en") 

# Spanish
cm23<-lpr_set_attr(cm23, notes, noteid = "note1", attribute_name = "qwording_es") 

# Portuguese
cm23<-lpr_set_attr(cm23, notes, noteid = "note3", attribute_name = "qwording_pt") 
