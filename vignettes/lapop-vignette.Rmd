...
```{r, time series}
fig1.1_data <- lpr_ts(gm, outcome = "ing4", rec = c(5, 7), use_wave = TRUE)
...
```{r, cross country}
fig1.2_data <- lpr_cc(ym, outcome = "ing4", rec = c(5, 7))
...
```{r, histogram}
spot32_data <- lpr_hist(ym, outcome = "vb21n")
