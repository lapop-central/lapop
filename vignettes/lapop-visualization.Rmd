...
lapop_ts(fig1.1_data,
         ymin = 50,
         ymax = 80,
         main_title = "Support for democracy decline a decade ago and 
         remains comparatively low in Brazil",
...
lapop_mline(fig2.1_data,
            main_title = "Trust in executives has declined to a level 
            similar to other political institutions",
            subtitle = "% who trust...")
```
...
lapop_ccm(fig2.3_data,
          main_title = "The public typically reports more trust in the 
          armed forces than the police, \nbut levels vary",
          subtitle = "% who trust...")
```
...
lapop_mover(fig_mover,
            main_title = "Satisfaction with democracy is significantly 
            lower among women, those with higher 
...
lapop_hist(spot32_data,
           main_title = "On average in the LAC region, 
           one in three say voting is the best way to influence change",
...
lapop_dumb(fig3.5_data,
           main_title = "Among those with emigration intentions, 
           the percentage who say they are very likely
...
lapop_stack(fig3.8_data,
            ...
            main_title = "Nicaragua has the highest percentage of 
            individuals with migration intentions, 
