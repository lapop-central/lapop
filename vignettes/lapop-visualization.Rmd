...
```{r, load data}
# AmericasBarometer 2023 Brazil (weighted)
data(bra23)

# AmericasBarometer 2006-2023 Brazil Merge
data(cm23)

# AmericasBarometer 2023 Year Merge (weighted)
data(ym23)
```

To apply design effects using lapop weights we use the lpr_data() function
...
The AmericasBarometer use `wt` weights for country specific AB datasets, and `weight1500` for comparative datasets.
