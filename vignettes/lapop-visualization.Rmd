...
#fig_mover$varlabel <- ifelse(fig_mover$varlabel == "edre", "Education", fig_mover$varlabel)

lapop_mover(fig_mover,
            main_title = "Satisfaction with democracy is significantly lower among women, those with higher 
