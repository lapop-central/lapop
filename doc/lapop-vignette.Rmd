...
lapop_ccm(fig2.3_data,
          main_title = "The public typically reports more trust in the armed forces 
          \nthan the police, but levels vary",
          subtitle = "% who trust...")
```

## Mover Example: Satisfaction with Democracy
...
lapop_stack(fig3.8_data,
            ...
            main_title = "Nicaragua has the highest percentage of individuals with migration 
            \nintentions, while Haiti has the lowest")
```
