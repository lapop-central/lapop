...
- titles, subtitles, and source info aligned with plot \*add country
  highlight option for ccm
...
Changes to lapop_ccm including: \* text placed directly above error bars
(no offset). Offset customizable with text_position argument.  
...
- Interpolation by group for lapop_tsmulti() now prevents interpolation
  of final data point
...
- Removed from lapop_save example and changed file directory to temp
